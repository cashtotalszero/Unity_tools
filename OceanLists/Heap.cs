...
public class Heap : MonoBehaviour {
	...
	void Start () {
		...
		oldWrite (thisSession, "Nested2att", 15, PIXE_PSML_WRITE_ATTRIBUTE);
		...
		oldWrite(thisSession,"psml://Root/Jellyfish2/Fixed?",null,PIXE_PSML_WRITE_ELEMENT);
		oldWrite(thisSession,"psml://Root/Jellyfish2/FixedDo",null,PIXE_PSML_WRITE_ELEMENT);
		oldWrite(thisSession,"psml://Root/Jellyfish2/FixedRe",null,PIXE_PSML_WRITE_ELEMENT);
		oldWrite(thisSession,"psml://Root/Jellyfish2/FixedMe",null,PIXE_PSML_WRITE_ELEMENT);
		oldWrite(thisSession,"psml://Root/Jellyfish2/Fixed?Egon",null,PIXE_PSML_WRITE_ELEMENT);
		//oldWrite(thisSession,"psml://Root/Jellyfish2/Fixed?Egon",null,PIXE_PSML_WRITE_ELEMENT);
		oldWrite(thisSession,"psml://Root/Crash",null,PIXE_PSML_WRITE_ELEMENT);
		oldWrite(thisSession,"psml://Root/Crash2",null,PIXE_PSML_WRITE_ELEMENT);
		oldWrite(thisSession,"psml://Root/Crash!!!",null,PIXE_PSML_WRITE_ELEMENT);
		Move (thisSession, "Crash!!!");
		oldWrite(thisSession,"Crash!ATT",4,PIXE_PSML_WRITE_ATTRIBUTE);


		object read = oldRead (thisSession,"Att 1", PIXE_PSML_READ_ATTRIBUTE);
		Debug.Log ("Expecting error = "+read);

		read = oldRead (thisSession,"psml://Root/Jellyfish1/Att 1", PIXE_PSML_READ_ATTRIBUTE);
		Debug.Log ("Expecting 29 = "+read);
